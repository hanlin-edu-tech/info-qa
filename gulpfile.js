...
function otherLibTask(dest){
    return function(){
        return gulp.src('src/other-lib/**/*')
            .pipe(gulp.dest(dest));};
}
...
gulp.task('otherLib', otherLibTask(`src/${version}/lib`));
gulp.task('build', ['clean'], function(){
    var deferred = Q.defer();
    Q.fcall(function(){return Q.all([
        util.logStream(libTask(`src/${version}/lib`)),
        util.logStream(otherLibTask(`src/${version}/lib`))])})
...
gulp.task('package', ['lib', 'otherLib'], function(branch){
